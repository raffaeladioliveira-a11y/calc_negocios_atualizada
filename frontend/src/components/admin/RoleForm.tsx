...
// Cores pré-definidas para os roles
const ROLE_COLORS = [
...
const RoleForm: React.FC<RoleFormProps> = ({ role, onSuccess, onCancel }) => {
    ...
    const validateForm = () => {
        ...
        if (!formData.name.trim()) {
            ...
            newErrors.name = 'Nome técnico deve conter apenas letras minúsculas e underscore';
        }
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-xs text-muted-foreground">
                            Apenas letras minúsculas e underscore. Ex: admin, user, manager
                        </p>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            placeholder="Administrador, Usuário, Gerente..."
